...
#define HCI_CONTROL_WIFI_ONBOARDING_COMMAND_SET_SSID          ( ( HCI_CONTROL_GROUP_WIFI_ONBOARDING << 8 ) | 0x01 )
...
#define HCI_CONTROL_LE_AUDIO_EVENT_MICS_AICS_DESC			( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x12 )  /* Event to notify AICS description*/
